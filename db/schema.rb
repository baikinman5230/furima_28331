...
ActiveRecord::Schema.define(version: 2020_09_03_160954) do
  ...
  create_table "addreses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["item_purchase_id"], name: "index_addreses_on_item_purchase_id"
  end
  ...
  add_foreign_key "addreses", "item_purchases"
